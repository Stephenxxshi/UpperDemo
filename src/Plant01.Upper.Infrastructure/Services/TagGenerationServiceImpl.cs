...
/// 标签生成服务实现（基础设施层）
/// </summary>
public class TagGenerationServiceImpl : ITagGenerationService
{
    private readonly ConfigurationLoader _configLoader;
    private readonly ILogger<TagGenerationServiceImpl> _logger;

    public TagGenerationServiceImpl(
        ConfigurationLoader configLoader,
        ILogger<TagGenerationServiceImpl> logger)
    {
