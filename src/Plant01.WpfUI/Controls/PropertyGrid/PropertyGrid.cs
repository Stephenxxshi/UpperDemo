...
public class PropertyGrid : Control
{
    ...
    public PropertyGrid()
    {
        ...
        CommandBindings.Add(new CommandBinding(SortByNameCommand, SortByName, (s, e) => e.CanExecute = ShowSortButton));
    }
    ...
    public static readonly DependencyProperty MaxTitleWidthProperty = DependencyProperty.Register(
        nameof(MaxTitleWidth), typeof(double), typeof(PropertyGrid), new PropertyMetadata(0.0));
    ...
    public static readonly DependencyProperty MinTitleWidthProperty = DependencyProperty.Register(
        nameof(MinTitleWidth), typeof(double), typeof(PropertyGrid), new PropertyMetadata(0.0));
    ...
    public override void OnApplyTemplate()
    {
        ...
        _searchBar = GetTemplateChild(ElementSearchBar) as AntInput;
    ...
    private void UpdateItems(object obj)
    {
        ...
        var properties = TypeDescriptor.GetProperties(obj.GetType()).OfType<PropertyDescriptor>()
    ...
    private void SearchBar_TextChanged(object sender, TextChangedEventArgs e)
    {
        ...
        _searchKey = _searchBar.Text.ToLower();
