...
public class IconToggleButton : ToggleButton
{
    ...
    public static readonly DependencyProperty IconProperty =
        DependencyProperty.Register("Icon", typeof(string), typeof(IconToggleButton), new PropertyMetadata(string.Empty, null, CoerceIcon));
    ...
    public static readonly DependencyProperty IconSizeProperty =
        DependencyProperty.Register("IconSize", typeof(double), typeof(IconToggleButton), new PropertyMetadata(12.0));
    ...
    public static readonly DependencyProperty IconFontFamilyProperty =
        DependencyProperty.Register("IconFontFamily", typeof(FontFamily), typeof(IconToggleButton), new PropertyMetadata(new FontFamily("Segoe UI Symbol")));
    ...
    public static readonly DependencyProperty IconPlacementProperty =
        DependencyProperty.Register("IconPlacement", typeof(IconPlacement), typeof(IconToggleButton), new PropertyMetadata(IconPlacement.Left));
    ...
    public static readonly DependencyProperty IconMarginProperty =
        DependencyProperty.Register("IconMargin", typeof(Thickness), typeof(IconToggleButton), new PropertyMetadata(new Thickness(0, 0, 5, 0)));
