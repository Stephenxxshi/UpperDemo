...
namespace Plant01.Core.BasicFramework
{
    /// <summary>
    ...
    public class SoftBasic
    {
        ...
        {
            return "ExceptionMessage" + ex.Message + Environment.NewLine +
                "ExceptionStackTrace" + ex.StackTrace + Environment.NewLine +
                "ExceptionTargetSite" + ex.TargetSite;
        }
        ...
        public static object DeepClone(object oringinal)
        {
            ...
            // 创建缓存的JsonSerializerOptions实例以提高性能
            ...
            return System.Text.Json.JsonSerializer.Deserialize(
                System.Text.Json.JsonSerializer.Serialize(oringinal, oringinal.GetType(), options),
                oringinal.GetType(), options);
        }

        /// <summary>
        /// 使用序列化反序列化深度克隆一个对象，泛型版本<br />
        /// Cloning an object with serialization deserialization depth, generic version
        /// </summary>
        ...
        public static T DeepClone<T>(T original)
        {
            ...
            return System.Text.Json.JsonSerializer.Deserialize<T>(
                System.Text.Json.JsonSerializer.Serialize(original, options), options);
        }
